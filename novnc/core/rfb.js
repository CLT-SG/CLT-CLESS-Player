...
export default class RFB extends EventTargetMixin {
    ...
    _setDesktopName(name) {
        ...
        this.dispatchEvent(new CustomEvent(
            "desktopname", { detail: { name: this._fb_name } }));
    }
    ...
    _updateConnectionState(state) {
        ...
        switch (state) {
            ...
            case 'disconnected':
                this.dispatchEvent(new CustomEvent(
                    "disconnect", {
                        detail: { clean: this._rfb_clean_disconnect }
                    }));
                break;
        }
    }
    ...
    _handle_security_reason() {
        ...
        if (reason !== "") {
            ...
            this.dispatchEvent(new CustomEvent(
                "securityfailure", { detail: { status: this._security_status } }));
    ...
    _negotiate_xvp_auth() {
        if (this._rfb_credentials.username === undefined ||
            ...
            this.dispatchEvent(new CustomEvent(
                "credentialsrequired", { detail: { types: ["username", "password", "target"] } }));
            return false;
        }
    ...
    _negotiate_vencrypt_auth() {
        ...
        if (this._rfb_vencrypt_state == 4) {
            if (!this._rfb_credentials.username ||
                ...
                this.dispatchEvent(new CustomEvent(
                    "credentialsrequired", { detail: { types: ["username", "password"] } }));
                return false;
            }
    ...
    _negotiate_std_vnc_auth() {
        ...
        if (this._rfb_credentials.password === undefined) {
            this.dispatchEvent(new CustomEvent(
                "credentialsrequired", { detail: { types: ["password"] } }));
            return false;
        }
    ...
    _handle_security_result() {
        ...
        if (status === 0) { // OK
            ...
            if (this._rfb_version >= 3.8) {
                ...
                this.dispatchEvent(new CustomEvent(
                    "securityfailure", { detail: { status: status } }));
        ...
        if (length >= 0) {
            ...
            if (isCaps) {
                ...
                if (textData !== null) {
                    ...
                    this.dispatchEvent(new CustomEvent(
                        "clipboard", { detail: { text: textData } }));
                }
            } else {
